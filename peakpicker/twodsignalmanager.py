import numpy as np
from .utils import readfile, plot_graph
...
class TwoDSignalManager:
    ...
    def plot_twod_signals(self, nmr_type):
        plot_graph([[signal.x_shift, signal.y_shift] for signal in self.twod_signals if signal.nmr_type == nmr_type])
...
def get_interaction_matrix():
    ...
    twod_signal_manager.add_nmr_signals("HSQC", 'resources/twod/hsqc/hsqc_peak_data.txt')
