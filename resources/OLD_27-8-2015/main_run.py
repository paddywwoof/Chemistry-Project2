...
def test_main():
    ...
    for x in range(1, 2000):
        print("RTC = %s"%(x/250))
        interaction_manager.add_spatial_interaction(index=1, interaction_name="COSY 3-Bond H-H   ", repulsive_amplitude=0.8, repulsive_time_constant=x/250, depth=3, attractive_amplitude=0.6, attractive_time_constant=200, power=3)
    for x in range(1, 2000):
        print("RTC = %s"%(x/250))
        interaction_manager.add_spatial_interaction(index=2, interaction_name="HSQC 1-Bond H-C   ", repulsive_amplitude=0.8, repulsive_time_constant=x/250, depth=3, attractive_amplitude=0.6, attractive_time_constant=200, power=3)
    for x in range(1, 2000):
        print("RTC = %s"%(x/250))
        interaction_manager.add_spatial_interaction(index=3, interaction_name="HMBC 2/3 Bond H-C ", repulsive_amplitude=0.8, repulsive_time_constant=x/250, depth=3, attractive_amplitude=0.6, attractive_time_constant=200, power=3)
    for x in range(1, 2000):
        print("RTC = %s"%(x/250))
        interaction_manager.add_spatial_interaction(index=4, interaction_name="INAD 1-Bond C-C   ", repulsive_amplitude=0.8, repulsive_time_constant=x/250, depth=3, attractive_amplitude=0.6, attractive_time_constant=200, power=3)
