...
from chemlab.graphics.renderers import CylinderRenderer, LineRenderer, CylinderImpostorRenderer
import numpy as np

class MyBondRenderer(AbstractRenderer):
    '''
    ...
    def __init__(self, widget, bonds, bond_colors, r_array, radius=0.02,
        ...
        for i, bond in enumerate(bonds):
            colors_a.append(bond_colors[i])
            colors_b.append(bond_colors[i])
